 ...
 */
public abstract class AbstractActivityBehaviorMessagingGateway extends ReceiveTaskActivity implements BeanFactoryAware, BeanNameAware, ActivityBehavior, InitializingBean {

  protected DefaultProcessVariableHeaderMapper defaultProcessVariableHeaderMapper;
  ...
  protected DefaultProcessVariableHeaderMapper returnInitializedInstance(ActivityExecution ex) {

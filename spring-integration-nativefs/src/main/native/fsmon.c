...
#ifndef _Included_org_springframework_integration_nativefs_eventdriven_fsmon_LinuxInotifyDirectoryMonitor
#define _Included_org_springframework_integration_nativefs_eventdriven_fsmon_LinuxInotifyDirectoryMonitor
#ifdef __cplusplus
extern "C" {
#endif

JNIEXPORT void JNICALL Java_org_springframework_integration_nativefs_fsmon_LinuxInotifyDirectoryMonitor_startMonitor(JNIEnv * env, jobject obj, jstring javaSpecifiedPath) {
// - setup inotify

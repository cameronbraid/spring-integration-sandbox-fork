...
public class AsyncSubmitReceiveSmsExample {
	private static TimeFormatter timeFormatter = new AbsoluteTimeFormatter();

	static ExtendedSmppSession clientSession() throws Throwable {
		SmppSessionFactoryBean smppSessionFactoryBean =
				new SmppSessionFactoryBean();
		smppSessionFactoryBean.setHost("127.0.0.1");
		smppSessionFactoryBean.setSystemId("smppclient1");
		smppSessionFactoryBean.setPassword("password");
		smppSessionFactoryBean.setPort(2775);
...
//		todo extendedSmppSession.start();
	...
	public static void main(String[] args) throws Throwable {
		...
		final ExtendedSmppSession session = clientSession();

		// Set listener to receive deliver_sm
		session.addMessageReceiverListener(new MessageReceiverListener() {
